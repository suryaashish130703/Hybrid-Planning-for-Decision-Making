...
def power(input: PowerInput) -> PowerOutput:
    """Compute a raised to the power of b. Supports decimal exponents (e.g., b=0.5 for square root). Usage: input={"input": {"a": 144, "b": 0.5}} result = await mcp.call_tool('power', input)"""
